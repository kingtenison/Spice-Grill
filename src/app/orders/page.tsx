    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container px-4 pt-20 pb-24 mx-auto lg:pl-sidebar space-y-6 sm:space-y-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/menu"
            className="px-6 py-3 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-colors shadow-lg shadow-red-500/20"
          >
            Order Again
          </Link>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6">
                      <h5 className="font-semibold text-gray-900 mb-3">Order Progress</h5>
        ...
        <div className="mt-12 bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-3">Come to our location</p>
              <address className="text-red-600 hover:text-red-700 font-medium not-italic">
                123 Grill Street<br />
                New York, NY 10001
              </address>
            </div>
