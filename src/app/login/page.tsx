...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Role-based redirect: send admins/employees/dispatchers straight to their panels
      setTimeout(async () => {
        try {
          ...
          if (role === "admin") {
            ...
            if (dispatcherData?.application_status === 'approved') {
              window.location.href = "/dispatcher";
            } else {
              window.location.href = "/menu";
            }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-red-600 mx-auto mb-4 animate-[spin_0.8s_linear_infinite]"></div>
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="mt-6">
              ...
              <a href="/api/auth/google" className="mt-4 w-full py-3 px-4 rounded-xl border border-gray-300 bg-white text-gray-700 font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-3">
